    ...
    render() {
        return (
           ...
           <View style={styles.card}>
              <Text style={styles.qt}>Modify Or Cancel</Text>
           </View>
               ...
               <View style={styles.card41}>
                   <View style={styles.radio}>
                       ...
                       <TouchableOpacity onPress={this.isModifyPressed} style={styles.radio1}>
                            <Image source={require('../../Images/dot-and-circle.png')} style={styles.ricon} />
                            <Text style={styles.rtextb}>Modify Order</Text>
                        </TouchableOpacity>
                           :
                       <TouchableOpacity onPress={this.isModifyPressed} style={styles.radio1}>
                           <Image source={require('../../Images/dot-and-circle-2.png')} style={styles.ricon} />
                           <Text style={styles.rtext}>Modify Order</Text>
                            </TouchableOpacity>
                           }
                            {
                            this.state.isCancel == true ?
                       <TouchableOpacity onPress={this.isCancelPressed} style={styles.radio1}>
                            <Image source={require('../../Images/dot-and-circle.png')} style={styles.ricon} />
                            <Text style={styles.rtextb}>Cancel Order</Text>
                        </TouchableOpacity>
                           :
                       <TouchableOpacity onPress={this.isCancelPressed} style={styles.radio1}>
                           <Image source={require('../../Images/dot-and-circle-2.png')} style={styles.ricon} />
                           <Text style={styles.rtext}>Cancel Order</Text>
                            </TouchableOpacity>
                           }
                    ...
                    <TextInputComponent onChangeText={text => this.setState({ FirstName: text })} placeholder='Departure Date'
                    underlineColorAndroid='grey' designStyle={{ width: '110%', right: 50,height: 50}} />
                     <TextInputComponent onChangeText={text => this.setState({ FirstName: text })} placeholder='Already Collected / Dropped Off'
                    underlineColorAndroid='grey' designStyle={{ width: '110%', right: 50,height: 50}} />
